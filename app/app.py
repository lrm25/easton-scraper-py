...
def retrieve_boulder_classes(class_date, gyms, number_of_days):
    ...
    boulder_calendar.get_and_parse_gyms_data(class_date, gyms, number_of_days)
...
def get_class_description(gym_name, class_id):
    ...
    description = boulder_calendar.get_class_description(link)
    print(description)
